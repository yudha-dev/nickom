					...
					<tbody>
						...
						foreach ($servis as $ss) : ?>
							<tr>
								...
								<?php elseif ($ss->status == 'Selesai') : ?>
									<td class="text-center font-w600 font-size-sm"><span class="badge badge-primary">Diproses</span></td>
								<?php else : ?>
									<td class="text-center font-w600 font-size-sm"><span class="badge badge-success">Sudah Dibayar</span></td>
								<?php endif; ?>
							</tr>
						<?php endforeach; ?>
					</tbody>
