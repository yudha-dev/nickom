...
<!-- Head -->
<?php $this->load->view('pemilik/templates/head'); ?>
...
<body>
	<div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
		...
		<aside id="side-overlay">
			<!-- Navbar -->
			<?php $this->load->view('pemilik/templates/navbar'); ?>
		</aside>
		<nav id="sidebar" aria-label="Main Navigation">
			<!-- Menu -->
			<?php $this->load->view('pemilik/templates/menu'); ?>
		</nav>
		<!-- Header -->
		<header id="page-header">
			<!-- header -->
			<?php $this->load->view('pemilik/templates/header'); ?>
		</header>
		<!-- Content -->
		<main id="main-container">
			<?php $this->load->view('pemilik/' . $folder . '/' . $page); ?>
		</main>
		<!-- Footer -->
		<footer id="page-footer" class="bg-body-light">
			<?php $this->load->view('pemilik/templates/footer'); ?>
		</footer>
		<!-- Modal -->
	...
	<!-- js -->
	<?php $this->load->view('pemilik/templates/js'); ?>
