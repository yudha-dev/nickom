                	...
                	<div class="content-side">
                		<ul class="nav-main">
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'beranda' ? 'active' : '' ?>" href="<?php echo site_url('pemilik/beranda') ?>">
                			...
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'user' ? 'active' : '' ?>" href="<?php echo site_url('pemilik/user/data_user') ?>">
                					<i class="nav-main-link-icon si si-user"></i>
                					<span class="nav-main-link-name">User</span>
                				</a>
                			</li>
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'servis' ? 'active' : '' ?>" href="<?php echo site_url('pemilik/servis/data_servis') ?>">
