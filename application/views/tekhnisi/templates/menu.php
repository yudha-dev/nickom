                	...
                	<div class="content-side">
                		<ul class="nav-main">
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'beranda' ? 'active' : '' ?>" href="<?php echo site_url('tekhnisi/beranda') ?>">
                			...
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'servis' ? 'active' : '' ?>" href="<?php echo site_url('tekhnisi/servis/data_servis') ?>">
                					<i class="nav-main-link-icon si si-settings"></i>
                					<span class="nav-main-link-name">Servis <span class="badge badge-danger"><?= notif() ?></span></span>
                				</a>
                			</li>
                			<li class="nav-main-item">
                				<a class="nav-main-link  <?php echo $this->uri->segment(2) == 'history_servis' ? 'active' : '' ?>" href="<?php echo site_url('tekhnisi/history_servis/data_history') ?>">
                					<i class="nav-main-link-icon fa fa-history"></i>
                					<span class="nav-main-link-name">History Servis</span>
                				</a>
                			</li>
                		</ul>
                	</div>
