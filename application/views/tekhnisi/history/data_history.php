				...
				<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
					<thead>
						<tr>
							...
							<th class="text-center">Biaya Servis</th>
					...
					<tbody>
						...
						foreach ($servis as $ss) : ?>
							<tr>
								...
								<td class="text-center font-w600 font-size-sm"><?= "Rp. " . number_format($ss->total_hrg_sparepart, 0, ',', '.') ?></td>
								<td class="text-center font-w600 font-size-sm"><?= "Rp. " . number_format($ss->tarif_servis, 0, ',', '.') ?></td>
								<td class="text-center font-w600 font-size-sm"><?= "Rp. " . number_format($ss->total_hrg_sparepart + $ss->tarif_servis, 0, ',', '.') ?></td>
								<td class="text-center font-w600"><span class="badge badge-success"><?= $ss->status ?></span></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
