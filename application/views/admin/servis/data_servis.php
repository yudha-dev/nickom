			...
			<div class="row">
				<div class="col-sm-12 mb-3">
					...
					<div class="text-center bg-body-light py-2 mb-2">
						<div class="dt-buttons"> <a href="<?= base_url('admin/servis/tambah_servis') ?>" class="btn btn-sm btn-rounded btn-outline-success" tabindex="0" type="button"><span> <i class="fa fa-fw fa-plus mr-1"></i>Tambah Data</span></a></div>
					</div>
				</div>
			</div>
					...
					<tbody>
						...
						foreach ($servis as $ss) : ?>
							<tr>
								...
								<?php if ($ss->status == 'Diproses') : ?>
									<td class="text-center font-w600 font-size-sm"><span class="badge badge-danger">Diproses</span></td>
								<?php else : ?>
									<td class="text-center font-w600 font-size-sm"><span class="badge badge-success">Selesai</span></td>
								<?php endif; ?>
