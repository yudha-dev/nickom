					...
					<tbody>
						...
						foreach ($pembayaran as $ss) : ?>
							<tr>
								...
								<?php if ($ss->status == 'Selesai') : ?>
									<td class="text-center font-w600 font-size-sm"><a href="<?= base_url('admin/pembayaran/proses_pembayaran/') . $ss->kode_servis ?>" class="btn btn-primary">Proses Pembayaran</a></td>
								<?php else : ?>
									<td class="text-center font-w600 font-size-sm"><a href="<?= base_url('admin/pembayaran/cetak_pembayaran/') . $ss->kode_servis ?>" class="btn btn-success" target="_blank">Cetak Pembayaran</a></td>
								<?php endif; ?>
							</tr>
						<?php endforeach; ?>
					</tbody>
