				...
				<div class="content">
					...
					<div class="block block-rounded">
						<?php if ($this->session->flashdata('kurang') == TRUE) : ?>
							<div class="alert alert-danger alert-dismissible fade show">
								<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
								<?= $this->session->flashdata('kurang') ?>.
							</div>
						<?php endif; ?>
						<div class="block-content block-content-full">
							<form action="<?= base_url('admin/sparepart/insert') ?>" method="POST" enctype="multipart/form-data">
								<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
								<div class="row push">
									<div class="col-lg-12 col-xl-12">
										<div class="form-group">
											<label for="example-text-input">Nama Sparepart</label>
											<input type="text" class="form-control" name="nama_sparepart" value="<?= set_value('nama_sparepart') ?>" placeholder="Masukan nama sparepart">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="keterangan" value="<?= set_value('keterangan') ?>" placeholder="Contoh : 16">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="harga_beli" id="rupiah" value="<?= set_value('harga_beli') ?>" placeholder="Masukan harga beli">
											<?= form_error('harga_beli', '<label class="text-danger">', '</label>'); ?>
										</div>
										<div class="form-group">
											<label for="example-text-input">Harga Jual</label>
											<input type="text" class="form-control" name="harga_jual" id="harga" value="<?= set_value('harga_jual') ?>" placeholder="Masukan harga jual">
